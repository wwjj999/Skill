...
# Agents-MD Pro v8.0 Ultimate — AI-Native Passive Context Development Framework

> **Version**: 8.0 Ultimate | **Philosophy**: Zero-Decision Burden & Passive Context
> **Last Audit**: 2026-02-22
> **Major Iteration**: Synchronized directory tree with actual project structure, fixed bilingual consistency, and corrected broken paths.
...
├── 📄 [PROJECT_STATUS.md](./PROJECT_STATUS.md)            # Current project governance state (auto-created on first run)
├── 📄 [USER_PROFILE.md](./USER_PROFILE.md)               # User persona & preferences (auto-generated after interview)
...
├── 📄 [replit.md](./replit.md)                      # Replit environment notes
├── 📄 [.gitignore](./.gitignore)                    # Git ignore rules
├── 📄 [.roomodes](./.roomodes)                      # Roo Code modes definition
│
│   # --- Standalone AI IDEs ---
├── 🤖 [GEMINI.md](./GEMINI.md)                      # Google Antigravity IDE adapter
├── 🤖 [.cursorrules](./.cursorrules)                  # Cursor IDE adapter
├── 🤖 [.windsurfrules](./.windsurfrules)               # Windsurf IDE adapter
├── 🤖 [.traerules](./.traerules)                    # Trae IDE adapter
├── 📁 [.zed/](./.zed/)                           # 🤖 Zed AI adapter
│   # --- Editor Plugins & Extensions ---
├── 📁 [.github/](./.github/)                       # 🐙 GitHub Copilot adapter
├── 📁 [.idea/](./.idea/)                          # 🤖 JetBrains AI adapter
├── 📁 [.lingma/](./.lingma/)                       # 🤖 Tongyi Lingma adapter
├── 📁 [.roo/](./.roo/)                           # 🛠️ Roo Code runtime
├── 📁 [.vscode/](./.vscode/)                       # 🛠️ VS Code settings
...
│   ├── auto_status.py                              # Project status auto-generator
│   ├── memory.md                                  # Architecture Decision Records (ADR)
│   └── status.md                                  # Live project state (auto-updated)
├── 📁 [scripts/](./scripts/)                       # ⚙️ Core Configuration & Utilities
│   ├── config.py                                  # SSOT for constants and core file definitions
│   └── utils.py                                   # Cross-directory path resolver
├── 📁 [docs/](./docs/)                            # 📚 Documentation & Assets
│   ├── AUTO_LOAD_GUIDE.md                           # AI auto-load guide
│   ├── GOD_MODE_INJECTION.md                         # God Mode injection protocol
│   └── images/                                    # Image assets
...
| **evo-asset** | 🔹 Complete | ⚡ Local | $0 | Structure & validate Gene/Capsule/EvolutionEvent assets. Inspired by the Evomap project, locally adapted for offline use |
...
- **Auto-Protection**: The memory-guardian daemon is **automatically loaded** and runs silently in the background via the `AGENTS.md` protocol and initialization scripts (`setup.bat` / `setup.sh`). No manual start is required.
...
| **Wireless Debug** | BLE (nRF Sniffer), LoRa, USB Protocol Analysis |
...
|:---|:---|:---|
| **Google Antigravity** | `.agents/`, `GEMINI.md` | ✅ Supported |
| **Cursor** | `.cursorrules` | ✅ Supported |
| **Windsurf** | `.windsurfrules` | ✅ Supported |
| **Trae** | `.traerules` | ✅ Supported |
| **Zed AI** | `.zed/ai.md`, `.zed/` | ✅ Supported |

### Editor Plugins & Extensions

| Tool | Config File | Status |
|:---|:---|:---|
| **Roo Code** | `.roo/`, `.roomodes` | ✅ Supported |
| **Cline (VS Code)** | `.clinerules` | ✅ Supported |
| **GitHub Copilot** | `.github/copilot-instructions.md`, `.github/` | ✅ Supported |
| **JetBrains AI** | `.idea/ai-instructions.md`, `.idea/` | ✅ Supported |
| **Augment Code** | `.augment-guidelines` | ✅ Supported |
| **Tongyi Lingma** | `.lingma/rules/project-rules.md`, `.lingma/` | ✅ Supported |
...
| **Codex CLI (OpenAI)** | `.codex/instructions.md`, `.codex/` | ✅ Supported |
...
> **最新审计**: 2026-02-22
> **重大迭代**: 同步目录树与实际项目结构，修复中英文一致性问题，修正路径错误。
...
├── 📄 [PROJECT_STATUS.md](./PROJECT_STATUS.md)            # 项目当前治理状态（首次运行后自动创建）
...
├── 📄 [package.json](./package.json)                  # Node.js 项目清单
├── 📄 [replit.md](./replit.md)                      # Replit 运行环境说明
├── 📄 [.gitignore](./.gitignore)                    # Git 忽略规则
├── 📄 [.roomodes](./.roomodes)                      # Roo Code 模式定义
│
│   # --- 独立 AI IDE ---
├── 🤖 [GEMINI.md](./GEMINI.md)                      # Google Antigravity IDE 适配器
├── 🤖 [.cursorrules](./.cursorrules)                  # Cursor IDE 适配器
├── 🤖 [.windsurfrules](./.windsurfrules)               # Windsurf IDE 适配器
├── 🤖 [.traerules](./.traerules)                    # Trae IDE 适配器
├── 📁 [.zed/](./.zed/)                           # 🤖 Zed AI 适配器
│   # --- 智能编辑器插件 ---
├── 📁 [.github/](./.github/)                       # 🐙 GitHub Copilot 适配器
├── 📁 [.idea/](./.idea/)                          # 🤖 JetBrains AI 适配器
├── 📁 [.lingma/](./.lingma/)                       # 🤖 通义灵码 (Lingma) 适配器
├── 📁 [.roo/](./.roo/)                           # 🛠️ Roo Code 运行时
├── 📁 [.vscode/](./.vscode/)                       # 🛠️ VS Code 设置
...
│   ├── auto_status.py                              # 项目状态自动生成器
│   ├── memory.md                                  # 架构决策记录 (ADR)
│   └── status.md                                  # 实时项目状态（自动更新）
├── 📁 [scripts/](./scripts/)                       # ⚙️ 核心配置与工具库
│   ├── config.py                                  # 常量与核心文件定义的单一事实来源 (SSOT)
│   └── utils.py                                   # 跨目录路径解析器
├── 📁 [docs/](./docs/)                            # 📚 文档与资源资产
│   ├── AUTO_LOAD_GUIDE.md                           # AI 自动加载指南
│   ├── GOD_MODE_INJECTION.md                         # 上帝模式注入协议
│   └── images/                                    # 图像资源
...
| **核心脚本** | `scripts/` | 共享配置、工具与 YAML 解析器 |
...
| **evo-asset** | 🔹 完整 | ⚡ 本地 | 0元 | 结构化管理 Gene/Capsule/EvolutionEvent 资产，借鉴自 Evomap 项目并进行本地化离线改造 |
...
- **方案**：实时物理内存监控 + 多级双语警告
- **自动保护**：内存监控守护进程**已实现自动加载**，通过 `AGENTS.md` 协议和启动脚本 (`setup.bat` / `setup.sh`) 自动在后台静默运行，无需手动启动。
...
| 工具 | 配置文件 | 状态 |
|:---|:---|:---|
| **Google Antigravity** | `.agents/`, `GEMINI.md` | ✅ 已适配 |
| **Cursor** | `.cursorrules` | ✅ 已适配 |
| **Windsurf** | `.windsurfrules` | ✅ 已适配 |
| **Trae** | `.traerules` | ✅ 已适配 |
| **Zed AI** | `.zed/ai.md`, `.zed/` | ✅ 已适配 |

### 智能编辑器插件

| 工具 | 配置文件 | 状态 |
|:---|:---|:---|
| **Roo Code** | `.roo/`, `.roomodes` | ✅ 已适配 |
| **Cline (VS Code)** | `.clinerules` | ✅ 已适配 |
| **GitHub Copilot** | `.github/copilot-instructions.md`, `.github/` | ✅ 已适配 |
| **JetBrains AI** | `.idea/ai-instructions.md`, `.idea/` | ✅ 已适配 |
| **Augment Code** | `.augment-guidelines` | ✅ 已适配 |
| **通义灵码 (Lingma)** | `.lingma/rules/project-rules.md`, `.lingma/` | ✅ 已适配 |

### CLI 智能工具

| 工具 | 配置文件 | 状态 |
|:---|:---|:---|
| **Claude Code** | `CLAUDE.md`, `.claude/` | ✅ 已适配 |
| **Gemini CLI** | `GEMINI.md`, `.gemini/` | ✅ 已适配 |
| **Qwen Code** | `QWEN.md` | ✅ 已适配 |
| **Aider** | `.aider.conf.yml`, `.aiderignore` | ✅ 已适配 |
| **Codex CLI (OpenAI)** | `.codex/instructions.md`, `.codex/` | ✅ 已适配 |
