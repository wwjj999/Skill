...
> **Version**: 8.0
 Ultimate | **Philosophy**: Zero-Decision Burden & Passive Context
> **Last Audit**: 2026-02-12
> **Major Iteration**: Refactored project reference logic & updated Skills usage specifications.
...
├── 📄 PRINCIPLES.DM          # Design Principles
├── 📄 CALL_CHAIN_ANALYSIS.md # Context System Architecture
├── 📄 PROJECT_FILES_ANALYSIS.md # Project Files Analysis
├── 📄 TOKEN_AUDIT.DM         # Token Audit
├── 📄 AI_RULES_INJECTION.txt # AI Rules Injection
...
├── 📄 CALL_CHAIN_ANALYSIS.md # 上下文系统架构分析
├── 📄 PROJECT_FILES_ANALYSIS.md # 项目文件分析
├── 📄 TOKEN_AUDIT.DM         # Token 使用审计
├── 📄 AI_RULES_INJECTION.txt # AI 规则注入
├── 📄 README.md              # 项目说明文档
...
<!-- 交互式星标趋势图，自动更新 -->
<iframe 
  src="https://ossinsight.io/widgets/official/compose?repo_name=wangjianjq%2FSkill&width=800&height=400&chart_type=stars_trend" 
  width="800" 
  height="400" 
  frameborder="0" 
  scrolling="no"
  style="border: 1px solid #eee; border-radius: 8px; background: #1e1e1e;"
></iframe>
