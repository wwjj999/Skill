...
workflow_path: '{project-root}/bmad/bmm/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/bmad/core/tasks/review-adversarial-general.xml</invoke-task>
```
