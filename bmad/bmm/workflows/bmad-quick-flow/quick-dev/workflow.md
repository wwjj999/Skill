...
- `quick_spec_workflow` = `{project-root}/bmad/bmm/workflows/bmad-quick-flow/quick-spec/workflow.md`
- `party_mode_exec` = `{project-root}/bmad/core/workflows/party-mode/workflow.md`
- `advanced_elicitation` = `{project-root}/bmad/core/workflows/advanced-elicitation/workflow.xml`
