...
# Task References
advancedElicitationTask: '{project-root}/bmad/core/workflows/advanced-elicitation/workflow.xml'
...
Epics and Stories complete. Read fully and follow: `bmad/core/tasks/bmad-help.md` with argument `Create Epics and Stories`.
