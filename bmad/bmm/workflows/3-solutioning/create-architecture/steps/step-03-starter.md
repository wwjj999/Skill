...
- Read fully and follow: {project-root}/bmad/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {project-root}/bmad/core/workflows/party-mode/workflow.md with starter evaluation context
