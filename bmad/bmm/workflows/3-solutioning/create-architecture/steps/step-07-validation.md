...
- Read fully and follow: {project-root}/bmad/core/workflows/advanced-elicitation/workflow.xml with validation issues
...
- Read fully and follow: {project-root}/bmad/core/workflows/party-mode/workflow.md with validation context
