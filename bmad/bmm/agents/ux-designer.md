...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CU or fuzzy match on ux-design" exec="{project-root}/bmad/bmm/workflows/2-plan-workflows/create-ux-design/workflow.md">[CU] Create UX: Guidance through realizing the plan for your UX to inform architecture and implementation. PRovides more details that what was discovered in the PRD</item>
