...
├── docs/                    # 项目文档与资源
│   └── images/              # 截图与媒体文件
├── AGENTS.md                # [核心] 主 Agent 协议与启动序列
├── AGENTS_INDEX.yaml        # [核心] 高密度知识索引
├── GEMINI.md                # Gemini CLI 专用协议
├── PROJECT_GOVERNANCE.md    # 项目治理规则
├── PROJECT_LANGUAGES.md     # 语言设置
└── README.md                # 项目说明文件
```
