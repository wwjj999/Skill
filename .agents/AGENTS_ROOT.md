...
| :--- | :--- | :--- | :--- |
| **Protocol Land** | `^\.agents\/.*` | **READ-ONLY** | 🛡️ **DEFEND**: Do not modify standard protocol files. |
| **User Land** | `^(?!\.agents\/).*` | **READ-WRITE** | ⚡ **ATTACK**: Full authority over project root, code, and `sandbox/`. |
